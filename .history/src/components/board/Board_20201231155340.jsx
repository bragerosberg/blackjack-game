    ...
    <div className="blackjack__wrapper">
      ...
      <section>
        <aside className="blackjack__dealer__wrapper">
          {allDealerCards.forEach((dealerCard, index) => {
            <Dealer style={index} key={dealerCard.id} card={dealerCard}/>
          })}
        </aside>
        <aside className="blackjack__player__wrapper">
          {allDealerCards.map(dealearCard => (
            <Dealer key={playerCard.id} card={playerCard}/>
          ))}
        </aside>
        <aside className="blackjack__player__wrapper">
